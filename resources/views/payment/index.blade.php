    ...
    <div class="card bg-primary text-white">
        ...
        <div class="card-body bg-light">
            ...
            <table class="table table-bordered admin-table__adapt admin-table__instrument">
                ...
                @forelse($payments as $payment)
                    <tr>
                        ...
                        <td data-label="Автомобиль" class="text-center"><a class="text-primary" href="{{ route('payment.show', $payment->car->car_id) }}">{{ Helper::carName($payment->car) }}</a></td>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                <a href="{{ route('payment.create', ['car' => request()->car]) }}" class="btn btn-primary rounded">Добавить трату</a>
            </div>
